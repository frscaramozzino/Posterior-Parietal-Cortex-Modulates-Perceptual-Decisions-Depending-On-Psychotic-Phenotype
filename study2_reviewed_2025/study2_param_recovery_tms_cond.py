...
mean_simulated_quantiles_coherence_tms.to_csv('mean_simulated_quantiles_coherence_tms.csv')
...
vat_tms_coh= hddm.load('vat_tms_coh2')
vat_tms_coh.print_stats()
...
for i in sample:
    ...
    simulated_data.append(data_sim)
    pd.concat(simulated_data).to_csv('simulated_data_coherence_tms2.csv')

mean_simulated_quantiles_coherence_tms=get_mean_sim_quantiles(simulated_data)
mean_simulated_quantiles_coherence_tms=mean_simulated_quantiles_coherence_tms.assign(source = "simulated")

mean_simulated_quantiles_coherence_tms.to_csv('mean_simulated_quantiles_coherence_tms2.csv')
...
mean_simulated_quantiles_coherence_tms=pd.read_csv('mean_simulated_quantiles_coherence_tms.csv')
...
def cohens_d(dist1, dist2):
    ...
    return effect_size
csd = 'SMD:'
csd_1 = str(cohens_d(observed_quantiles['q_correct'], mean_simulated_quantiles_coherence_tms['q_correct']).round(3))
csd_1="".join([csd,csd_1])
csd_0 = str(cohens_d(observed_quantiles['q_incorrect'], mean_simulated_quantiles_coherence_tms['q_incorrect']).round(3))
csd_0="".join([csd,csd_0])
#qq plots
fig = make_subplots(
    rows=1, cols=2
)
...
fig.update_xaxes(title_text="Observed RT quantiles", range=[0,7])

# Update yaxis properties
fig.update_yaxes(title_text="Simulated RT quantiles",range=[0,7])
...
v_sham=[vat_tms_coh_traces[['v(0.15.0.0)']], vat_tms_sim_traces[['v(0.15.0.0)']], 
        vat_tms_coh_traces[['v(0.05.0.0)']], vat_tms_sim_traces[['v(0.05.0.0)']]]

v_tms=[vat_tms_coh_traces[['v(0.15.1.0)']], vat_tms_sim_traces[['v(0.15.1.0)']], 
        vat_tms_coh_traces[['v(0.05.1.0)']], vat_tms_sim_traces[['v(0.05.1.0)']]]



v_coh=vat_tms_coh_traces[['v(0.15.0.0)', 'v(0.15.1.0)',
                          'v(0.05.0.0)', 'v(0.05.1.0)']]
...
a_sham=[vat_tms_coh_traces[['a(0.15.0.0)']], vat_tms_sim_traces[['a(level_sham_15)']], 
        vat_tms_coh_traces[['a(0.05.0.0)']], vat_tms_sim_traces[['a(level_sham_05)']]]

a_tms=[vat_tms_coh_traces[['a(0.15.1.0)']], vat_tms_sim_traces[['a(level_tms_15)']], 
        vat_tms_coh_traces[['a(0.05.1.0)']], vat_tms_sim_traces[['a(level_tms_05)']]]
...
t_sham=[vat_tms_coh_traces[['t(0.15.0.0)']], vat_tms_sim_traces[['t(level_sham_15)']], 
        vat_tms_coh_traces[['t(0.05.0.0)']], vat_tms_sim_traces[['t(level_sham_05)']]]

t_tms=[vat_tms_coh_traces[['t(0.15.1.0)']], vat_tms_sim_traces[['t(level_tms_15)']], 
        vat_tms_coh_traces[['t(0.05.1.0)']], vat_tms_sim_traces[['t(level_tms_05)']]]
